    ...
    <|
        row [ width (fill) ]
            ...
            , column [ width (fillPortion 3) ]
                ...
                -}
                , row [ paddingEach { bottom = 30, left = 0, right = 0, top = 30 } ]
                    [ column [ width (fillPortion 1) ] [ el [ centerX ] (image [] { src = "http://www.americancraftspirits.com/wp-content/uploads/2013/11/b1.jpg", description = "" }) ]
                    , column [ width (fillPortion 1) ] [ el [ centerX ] (image [] { src = "http://www.americancraftspirits.com/wp-content/uploads/2013/11/b2.jpg", description = "" }) ]
                    , column [ width (fillPortion 1) ] [ el [ centerX ] (image [] { src = "http://www.americancraftspirits.com/wp-content/uploads/2013/11/b3.jpg", description = "" }) ]
                    ]
                ...
                , row
                    ...
                    , column [ width (fillPortion 2) ]
                        ...
                        , paragraph [ width (shrink), centerX, paddingEach { bottom = 10, left = 20, right = 0, top = 0 } ] [ el [ Font.size 13, Font.alignLeft ] (text "We provide 100% satisfactory regarding to the quality and quantity of the wine. Wine is best in taste and having elegant color. We never ever like to compromise on the quality of the wine") ]
                        ]
                    , column [ width (fillPortion 2) ]
                        ...
                        , paragraph [ width (shrink), centerX, paddingEach { bottom = 10, left = 20, right = 0, top = 0 } ] [ el [ Font.size 13, Font.alignLeft ] (text "Your suggestions and valuable comments are very important for us. We always like to hear what are your desires with us, what are your expectations and what you want more from us.") ]
                        ]
                    ]
                ]
            , el
